...
<div class="wp-block-columns"><!-- wp:column {"width":"70%","className":"post-col"} -->
...
<!-- wp:column {"width":"30%","className":"sidebar-col"} -->
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"cyber-security-blocks","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->